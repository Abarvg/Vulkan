...
CComputeApplication::CComputeApplication()
{
}
...
void CComputeApplication::initVulkan() {
    ...
    // Initialize vulkan:
    CComputeApplication::createInstance();
    findPhysicalDevice();
    createDevice();
    createBuffer();
...
void CComputeApplication::createInstance() {
...
void CComputeApplication::findPhysicalDevice() {
    /*
...
uint32_t CComputeApplication::getComputeQueueFamilyIndex() {
...
void CComputeApplication::createDevice() {
    /*
...
uint32_t CComputeApplication::findMemoryType(uint32_t memoryTypeBits, VkMemoryPropertyFlags properties) {
...
void CComputeApplication::createBuffer() {
    /*
...
void CComputeApplication::createDescriptorSetLayout() {
    /*
...
void CComputeApplication::createDescriptorSet() {
    /*
...
uint32_t* CComputeApplication::readFile(uint32_t& length, const char* filename) {
...
void CComputeApplication::createComputePipeline() {
    /*
...
void CComputeApplication::createCommandBuffer() {
    /*
...
void CComputeApplication::runCommandBuffer() {
    /*
...
void CComputeApplication::cleanup() {
    /*
